...
def detect_key_point(model_path, frame, out_dir, inWidth=368, inHeight=368, threshhold=0.2):
...
if __name__ == "__main__":
    ...
    detect_key_point(model_path, img, out_dir, inWidth=368, inHeight=368, threshhold=0.05)
